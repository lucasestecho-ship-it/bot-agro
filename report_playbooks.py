...
REPORT_PLAYBOOKS = {
    ...
    "informe_recorrida": ReportPlaybook(
        ...
        required_data=(
            ...
            "observaciones y recomendaciones expresamente registradas",
            "fotos, audios y coordenadas vinculados a la recorrida",
            "compromisos, responsables y fechas confirmadas",
        ),
        calculations=(
            "solo calculos derivados de datos registrados, con formula y unidad",
            "impacto economico preliminar o lista exacta de datos faltantes",
        ),
        sections=(
            "Resumen ejecutivo",
            "Datos generales y recorrido",
            "Diagnostico por tema o sector",
